...
from welcome_support import _, settings, lp, change_autolaunch
...
class WelcomeWindow(Adw.Window):
    ...
    def __init__(self, **kwargs) -> None:
        ...
        self.autolaunch.set_active(settings["autostart"])
        self.autolaunch.connect("toggled", self.on_autolaunch_toggled)
    ...
    def on_close_button_clicked(self, button) -> None:
        win.close()

    def on_autolaunch_toggled(self, button) -> None:
